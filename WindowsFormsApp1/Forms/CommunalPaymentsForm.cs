...
{
    public partial class CommunalPaymentsForm : Form
    {
        ...
        private void CommunalPaymentsForm_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void CommunalPaymentsForm_Load(object sender, EventArgs e)
        {
        ...
        private void PayButton_Click(object sender, EventArgs e)
        {
            ...
            if (cardCurrency != "RUB")
            {
                MessageBox.Show("Оплата коммунальных услуг может производиться только в рублях", "Отмена", MessageBoxButtons.OK, MessageBoxIcon.Information);
                error = true;
            }
